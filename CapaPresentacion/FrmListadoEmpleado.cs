...
namespace CapaPresentacion
{
    public partial class FrmListadoEmpleado : Form
    {
        ...
        private void btneditar_Click(object sender, EventArgs e)
        {
            ...
            form.txtdireccion.Text = dlistado.CurrentRow.Cells["telefono"].Value.ToString();
        ...
        private void btneditar_Click_1(object sender, EventArgs e)
        {
            ...
            form.txtdireccion.Text = this.dlistado.CurrentRow.Cells["telefono"].Value.ToString();
        ...
        private void btneliminar_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dlistado.SelectedRows.Count > 0)
                {
                    ...
                    {
                        string idempleado = dlistado.CurrentRow.Cells["idempleado"].Value.ToString();
                        CNCliente.Eliminar(Convert.ToInt32(idempleado));
