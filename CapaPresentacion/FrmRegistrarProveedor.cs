        ...
        private void btnguardar_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    if (this.Insert == true)
                    {
                        CNProveedor.Guardar(this.txtrazonsocial.Text,
                                          this.txtdni.Text,
                                          this.txtrfc.Text,
                                          this.txttelefono.Text,
                                          this.txtdireccion.Text,
                                          estado);
                        MessageBox.Show("Proveedor registrado correctamente", "Sistema de Ventas",
                    ...
                    else if (this.Edit == true)
                    {
                        CNProveedor.Editar(Convert.ToInt32(this.txtidproveedor.Text),
                                         this.txtrazonsocial.Text,
                                          ...
                                          this.txtdireccion.Text,
                                          estado);
                        MessageBox.Show("Proveedor editado correctamente", "Sistema de Ventas",
                            MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    this.Insert = false;
                    this.Edit = false;
